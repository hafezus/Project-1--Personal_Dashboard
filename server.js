...
app.post('/weather', (req, res)=>{
    ...
    //let url = `asdd` //Hardcoded Dubai. Change this depending on your location
...
app.post('/news', (req, res)=>{
    let url = `http://newsapi.org/v2/everything?q=bitcoin&from=2021-1-1&sortBy=publishedAt&apiKey=${NEWSAPI_API_KEY}`; //Hardcoded Dubai. Change this depending on your location
    //let url = `asd`; //Hardcoded Dubai. Change this depending on your location
